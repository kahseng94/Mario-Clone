...
namespace Sprint5.Entities.Enemies.Koopa
{
    public class KoopaLeftMovingState : IEnemyState
    {
        ...
        public KoopaLeftMovingState(Game1 game, Koopa koopa)
        {
            this.koopa = koopa;
            this.game = game;
            koopaSprite = KoopaSpriteFactory.Instance.CreateKoopaLeftMovingSprite();
        }

        public void ChangeDirection()
        {
            koopa.State = new KoopaRightMovingState(game, koopa);
        }
